function createHighlightedHTMLContent(htmlContent, plainText, plainTextPositions) {
    
    function wrapWithHighlight(word) {
    ...
    plainTextPositions.forEach(({ start, end }) => {
      ...
      highlightedContent = highlightedContent.replace(regex, wrapWithHighlight);
    });
  ...
  const highlightedContent = createHighlightedHTMLContent(htmlContent, plainText, plainTextPositions);
